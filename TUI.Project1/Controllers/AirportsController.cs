...
namespace TUI.Project1.Controllers
{
    public class AirportsController : CrudController<Airport>
    {
        ...
        public override ActionResult Create([Bind(Include = "Id,LocationId,Name,CityId")] Airport airport)
        {
            return base.Create(airport);
        }

        // 详细信息，请参阅 https://go.microsoft.com/fwlink/?LinkId=317598。
        [HttpPost]
        [ValidateAntiForgeryToken]
        public override ActionResult Edit([Bind(Include = "Id,LocationId,Name,CityId")] Airport airport)
        {
            return base.Edit(airport);
        }
    }
}